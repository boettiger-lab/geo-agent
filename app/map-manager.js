...
export class MapManager {
    ...
    /**
     * Return every MapLibre layer ID that belongs to this logical layer,
     * in bottom-to-top paint order. Used by the reorder primitives so a
     * vector fill + outline (and all version sublayers) move as a group.
     */
    ...
    /**
     * Move logical layer `a` below logical layer `b` in the paint stack.
     * "Below" = paints underneath, visually lower.
     */
